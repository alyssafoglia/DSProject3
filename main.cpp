...
int main()
{
    ...
    while (input != "-1") {
        ...
        if (stoi(input) == 1) {
            ...
            hash.SearchTitle(movieTitle);
            chrono::steady_clock::time_point end2 = chrono::steady_clock::now();
            cout << "Microseconds: " << chrono::duration_cast<chrono::microseconds>(end2 - start2).count();
        }
